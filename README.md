...
- [tbdex-js](https://github.com/cyware/tbdex-js)
- [tbdex-kt](https://github.com/cyware/tbdex-kt)
- [tbdex-rs](https://github.com/cyware/tbdex-rs)
- [web5-js](https://github.com/cyware/web5-js)
- [web5-kt](https://github.com/cyware/web5-kt)
- [web5-rs](https://github.com/cyware/web5-rs)
...
Feature tracking will take place entirely on GitHub through Github Issues and the [SDK development Github project](https://github.com/orgs/cyware/projects/29).
...
All relevant Github Issues will be tracked in the [SDK Development](https://github.com/orgs/cyware/projects/29) Project. Issues can be associated to the project through the sidebar on an individual issue page. If a new issue is created in any of the SDK repos with one of the below feature labels, it will _automatically_ be added to the project board via GH project workflows. _New_ features lables should be added to the [workflows](https://github.com/orgs/cyware/projects/29/workflows).
...
> [!IMPORTANT]
> At a _minimum_, API reference documentation will be published to the respective sdk repository's Github Pages. e.g. `https://cyware.github.io/tbdex-kt/`
...
This repo serves as the home for all web5 feature related vectors. They are available in the [web5-test-vectors](./web5-test-vectors/) directory and hosted on [Github Pages](https://cyware.github.io/sdk-development/web5-test-vectors).

The `tbdex` repo houses tbdex feature related vectors. They are available in the [test-vectors](https://github.com/cyware/tbdex/test-vectors) directory and hosted on [Github Pages](https://tbdex.dev/).
...
```kt
// for web5 vectors
val stream = URL("https://cyware.github.io/sdk-development/web5-test-vectors/did-jwk/resolve.json").openStream()
...
Create a PR in this repo for web5 vectors, or in [`tbdex`](https://github.com/cyware/tbdex) for tbdex vectors with the proposed changes or additions.

#### Feature Completeness By SDK

Test vectors are also used to determine feature completeness via our [test harness](./test-harness/README.md). Results of test harness runs can be found [here](https://cyware.github.io/sdk-development/).
...
### [`did:dht`](https://cyware.github.io/did-dht-method/)
